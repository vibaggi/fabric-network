...
async function main() {
  ...
  try {
    ...
    // const history = await contract.evaluateTransaction('getHistoryLote', 'CX0');

    // console.log(history.toString())
    // let bufferHistory = Buffer.from(JSON.parse(history).data);
    // console.log(bufferHistory.toString('utf8'));
